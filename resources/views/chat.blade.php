...
<div class="flex flex-wrap items-center bg-gradient-to-tl from-green-400 via-black to-rose-500 h-screen">
    <div class="container mx-auto">
        <div class="min-w-full shadow-md rounded lg:grid lg:grid-cols-3">
            <div class="bg-zinc-900 lg:col-span-1">
                <div class="mx-3 my-3">
