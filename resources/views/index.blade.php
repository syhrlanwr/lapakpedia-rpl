...
<section class="w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right" style="max-width:1600px; height: 32rem; background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80');">
	<div class="container mx-auto">
		<div class="flex flex-col w-full lg:w-1/2 justify-center items-start  px-6 tracking-wide">
			<h1 class="text-gray-300 text-2xl my-4">Stripy Zig Zag Jigsaw Pillow and Duvet Set</h1>
			<a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-gray-300 hover:border-black" href="#">products</a>
		</div>
	  </div>
</section>
-->
<!-- Content -->
<section class="bg-gradient-to-tl from-green-400 via-black to-rose-500 py-8">

    <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12 bg-zinc-900 rounded-lg">

        <nav id="store" class="w-full z-30 top-0 px-6 py-1">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">

                <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-white text-xl "
                    href="#">
                    Store
                </a>
                ...
                <div class="flex items-center" id="store-nav-content">
                    ...
                    <a class="pl-3 inline-block no-underline hover:text-gray-300 text-white" href="#">
                        <svg class="fill-current hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
            <a href="#">
                ...
                <div class="pt-3 flex items-center justify-between">
                    ...
                    <svg class="h-6 w-6 fill-current text-white hover:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
                            d="M12,4.595c-1.104-1.006-2.512-1.558-3.996-1.558c-1.578,0-3.072,0.623-4.213,1.758c-2.353,2.363-2.352,6.059,0.002,8.412 l7.332,7.332c0.17,0.299,0.498,0.492,0.875,0.492c0.322,0,0.609-0.163,0.792-0.409l7.415-7.415 c2.354-2.354,2.354-6.049-0.002-8.416c-1.137-1.131-2.631-1.754-4.209-1.754C14.513,3.037,13.104,3.589,12,4.595z M18.791,6.205 c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 c0.76-0.756,1.754-1.172,2.799-1.172s2.035,0.416,2.789,1.17l0.5,0.5c0.391,0.391,1.023,0.391,1.414,0l0.5-0.5 C14.719,4.698,17.281,4.702,18.791,6.205z" />
                    </svg>
                </div>
                <p class="pt-1 text-white">£9.99</p>
            </a>
        </div>
...
<!-- <section class="bg-white py-8">
        ...
        <div class="container py-8 px-6 mx-auto">
            ...
            <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-white text-xl mb-8"
                href="#">
                About
            </a>
            ...
            <p class="mt-8 mb-8">This template is inspired by the stunning nordic minamalist design - in particular:
                <br>
                <a class="text-white underline hover:text-white-900" href="http://savoy.nordicmade.com/"
                    target="_blank">Savoy Theme</a> created by <a class="text-white underline hover:text-white-900"
                    href="https://nordicmade.com/">https://nordicmade.com/</a> and <a
                    class="text-white underline hover:text-white-900" href="https://www.metricdesign.no/"
            ...
            <div class="w-full mx-auto flex flex-wrap">
                <div class="flex w-full lg:w-1/2 ">
                    <div class="px-3 md:px-0">
                        <h3 class="font-bold text-white-900">About</h3>
                        <p class="py-4">
                ...
                <div class="flex w-full lg:w-1/2 lg:justify-end lg:text-right">
                    <div class="px-3 md:px-0">
                        <h3 class="font-bold text-white-900">Social</h3>
                        <ul class="list-reset items-center pt-3">
                            <li>
                                <a class="inline-block no-underline hover:text-gray-300 hover:underline py-1" href="#">Add
                                    social links</a>
                            </li>
                        </ul>
                    </div>
